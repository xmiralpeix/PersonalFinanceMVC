    ...
    <div class="register-box">
        ...
        <div class="register-box-body">
            ...
            <div class="form-group has-feedback">
                <div class="col-md-10">
                    @Html.TextBoxFor(Function(m) m.FullName, New With {.class = "form-control", .PlaceHolder = "Full Name"})
            ...
            <div class="form-group has-feedback">               
                <div class="col-md-10">
                    @Html.PasswordFor(Function(m) m.ConfirmPassword, New With {.class = "form-control", .PlaceHolder = "Confirm Password"})
